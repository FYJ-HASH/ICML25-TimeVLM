...
class Exp_Zero_Shot_Forecast(Exp_Basic):
    ...
    def _get_data(self, flag):
        if flag == 'test':
            ...
            test_args.data = self.args.target_data
            test_args.root_path = self.args.target_root_path
            test_args.data_path = self.args.target_data_path
            data_set, data_loader = data_provider(test_args, flag)
    ...
    def train(self, setting):
        ...
        print('Train data:', train_data.data_path)
        print('Vali data:', vali_data.data_path)
        print('Test data:', test_data.data_path)
